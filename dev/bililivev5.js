    ...
    $().ready(function(){
        ...
        function getSmallTV_join(roomid,short_id,data_g){
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.code===0){
                        msg("你从直播间【"+short_id+"】抽到了【"+data_g.from_user.uname+"】赠送的礼物： "+data.data.award_name+" X "+data.data.award_num+" !","success",5000);
                        console.log(CurentTime()+"你从直播间【"+short_id+"】抽到了【"+data_g.from_user.uname+"】赠送的礼物： "+data.data.award_name+" X "+data.data.award_num+" !");
